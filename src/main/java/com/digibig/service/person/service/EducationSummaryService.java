...
@Service
@Validated
public class EducationSummaryService extends AbstractServiceForItem<EducationSummary> {

  Logger logger = LoggerFactory.getLogger(this.getClass());

  public EducationSummaryService() {
    super(EducationSummary.class, "personId");
  }
